    ...
    <InfoContainer>
      ...
      <div className="infos">
        <p>
          ...
          diversidade, a prosperidade e o bem-estar das pessoas e do meio
          ...
          cuidar.mbiente. Isso significa uma radical desaprendizagem da moda
          como a conhecemos, desenraizando a lógica do crescimento infinito,
          superprodução e consumo excessivo e, em vez disso, encontrando
          maneiras novas e mais conscientes de desfrutar e dar valor à moda.
          Acreditamos na circularidade da moda, e por isso, nosso intuito é
          evitar o descarte em excesso e o consumo desenfreado, dando
...
const InfoContainer = styled.div`
  ...
  padding: 20px 150px;
  margin: 0 auto;
  background: linear-gradient(180deg, #f6f3e4 60%, #c0bda1 100%);
